...
int main(int argc, char *argv[])
{
  ...
  FelgoApplication felgo;
   // qmlRegisterType<GameData>("GameDataType",1.0,"GameData");
  ...
  felgo.setMainQmlFileName(QStringLiteral("qml/GameMain.qml"));
...
//  felgo.setMainQmlFileName(QStringLiteral("qrc:/qml/SimpleGameCocosNinjaMain.qml"));
